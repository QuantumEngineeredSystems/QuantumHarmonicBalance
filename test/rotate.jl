...
@testset begin
    ...
    @test string(rot) ==
          "(6*(a′*a′*a*a)+3+12*(a′*a)+6exp((0 + 2im)*t*ω)*(a*a)+4exp((0 + 2im)*t*ω)*(a′*a*a*a)+6exp((0 - 2im)*t*ω)*(a′*a′)+4exp((0 - 2im)*t*ω)*(a′*a′*a′*a)+exp((0 - 4im)*t*ω)*(a′*a′*a′*a′)+exp((0 + 4im)*t*ω)*(a*a*a*a)+-ω*(a′*a))"
end
